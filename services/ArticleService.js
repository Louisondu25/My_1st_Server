            ...
            .then((value) => {
                try {
                    if (value) {
                        ...
                        callback({
                            msg: "Aucun Article trouvé.", type_error: "no-found",
                        });
                    }
                } catch (e) {
    ...
    if (tab_field && Array.isArray(tab_field) && value && _.filter(tab_field, (e) => {
        ...
        Article.findOne({ $or: obj_find }, null, opts).then((value) => {
            if (value) {
                ...
                callback({ msg: 'Articles non trouvé.', type_error: 'no-found' })
            }
        }).catch((err) => {
...
module.exports.findManyArticleByIds = function (articles_id, options, callback) {
    var opts = { populate: (options && options.populate ? [user_Id] : []), lean: true }
    if (
        articles_id && Array.isArray(articles_id) && articles_id.length > 0 && articles_id.filter((e) => {
...
module.exports.findManyArticles = function (search, page, limit, options, callback) {
...
module.exports.updateManyArticles = function (articles_id, update, options, callback) {
    if (typeof articles_id === 'object' && Array.isArray(articles_id) && articles_id.length > 0 && articles_id.filter((e) => { return mongoose.isValidObjectId(e) }).length == articles_id.length) {
        articles_id = articles_id.map((e) => {
            return new ObjectId(e);
        });
        Article.updateMany({ _id: { $in: articles_id } }, update, { runValidators: true })
            .then((value) => {
                try {
            ...
            .then((value) => {
                try {
                    if (value) callback(null, value.toObject());
                        ...
                        callback({
                            msg: "Article non trouvé.", type_error: "no-found",
                        });
                } catch (e) {
...
module.exports.deleteManyArticles = function (articles_id, options, callback) {
    if (articles_id && Array.isArray(articles_id) && articles_id.length > 0 && articles_id.filter((e) => {
        return mongoose.isValidObjectId(e);
    }).length == articles_id.length) {
        articles_id = articles_id.map((e) => {
            return new ObjectId(e);
